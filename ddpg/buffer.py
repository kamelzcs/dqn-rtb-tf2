...
class Buffer:
    def __init__(self, gamma, target_actor, target_critic, critic_model, critic_optimizer, actor_model, actor_optimizer,
                 buffer_capacity=100000, batch_size=64, num_states=5, num_actions=1):
    ...
    def record(self, obs_tuple):
        ...
        self.action_buffer[index] = obs_tuple[0]
